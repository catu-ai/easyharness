...
var canonicalTransitionFamilies = []transitionFamily{
	...
	{ID: "step_implement_to_explicit_earlier_review", From: "execution/step-<n>/implement", To: "execution/step-<i>/review", Driver: "`harness review start` with explicit `step=<i>`", RequiredInputs: "Step `<i>` intentionally needs an optional risk-boundary review or repair"},
	{ID: "step_implement_to_next_step_implement", From: "execution/step-<n>/implement", To: "execution/step-<m>/implement", Driver: "Derived from current plan edits", RequiredInputs: "Step `<n>` becomes durably complete, no intentionally started step review is unresolved, and another unfinished step exists"},
	{ID: "step_implement_to_finalize_review", From: "execution/step-<n>/implement", To: "execution/finalize/review", Driver: "Derived from current plan edits", RequiredInputs: "Step `<n>` becomes durably complete, no intentionally started step review is unresolved, and no unfinished steps remain"},
	...
	{ID: "step_review_to_step_implement_clean", From: "execution/step-<n>/review", To: "execution/step-<n>/implement", Driver: "harness review aggregate", RequiredInputs: "Latest aggregate has no blocking findings"},
	{ID: "step_review_to_step_implement_repair", From: "execution/step-<n>/review", To: "execution/step-<n>/implement", Driver: "harness review aggregate", RequiredInputs: "Latest aggregate has blocking findings or an unrecoverable conservative outcome"},
	{ID: "explicit_earlier_review_to_step_implement_repair", From: "execution/step-<i>/review", To: "execution/step-<i>/implement", Driver: "harness review aggregate", RequiredInputs: "The explicit step review has blocking findings or an unrecoverable conservative outcome"},
	{ID: "explicit_earlier_review_to_ordinary_frontier", From: "execution/step-<i>/review", To: "`execution/step-<m>/implement` or `execution/finalize/...`", Driver: "harness review aggregate", RequiredInputs: "The explicit step review has no blocking findings"},
	...
	{ID: "finalize_review_to_explicit_earlier_review", From: "execution/finalize/review", To: "execution/step-<i>/review", Driver: "`harness review start` with explicit `step=<i>`", RequiredInputs: "A concrete intermediate risk boundary intentionally needs a step-bound review before finalize can be trusted"},
	{ID: "finalize_review_to_finalize_fix", From: "execution/finalize/review", To: "execution/finalize/fix", Driver: "harness review aggregate", RequiredInputs: "Latest finalize review aggregate has blocking findings or an unrecoverable conservative outcome"},
	{ID: "finalize_review_to_finalize_archive", From: "execution/finalize/review", To: "execution/finalize/archive", Driver: "Derived from finalize review with no blocking findings", RequiredInputs: "Finalize review is satisfied and archive closeout work remains"},
	...
	{ID: "finalize_fix_to_explicit_earlier_review", From: "execution/finalize/fix", To: "execution/step-<i>/review", Driver: "`harness review start` with explicit `step=<i>`", RequiredInputs: "Finalize repair intentionally needs a bounded step-risk review"},
	{ID: "finalize_fix_to_finalize_review", From: "execution/finalize/fix", To: "execution/finalize/review", Driver: "harness review start", RequiredInputs: "A linked repair delta or materially necessary new full finalize round is started after repair"},
	...
	{ID: "finalize_archive_to_publish", From: "execution/finalize/archive", To: "execution/finalize/publish", Driver: "harness archive", RequiredInputs: "Finalize review is satisfied, archive closeout is ready, and no intentionally started review remains unresolved"},
