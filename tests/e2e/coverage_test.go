...
var canonicalTransitionFamilies = []transitionFamily{
	...
	{ID: "publish_to_await_merge", From: "execution/finalize/publish", To: "execution/finalize/await_merge", Driver: "Evidence", RequiredInputs: "Current publish, CI, and sync evidence supports merge readiness."},
