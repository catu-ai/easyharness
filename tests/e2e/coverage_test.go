...
var canonicalTransitionFamilies = []transitionFamily{
	...
	{ID: "finalize_fix_to_finalize_review", From: "execution/finalize/fix", To: "execution/finalize/review", Driver: "harness review start", RequiredInputs: "A new finalize review round is started after repair and no unresolved earlier-step closeout debt remains"},
	...
	{ID: "finalize_archive_to_publish", From: "execution/finalize/archive", To: "execution/finalize/publish", Driver: "harness archive", RequiredInputs: "Finalize review is satisfied, archive closeout is ready, and no unresolved earlier-step closeout debt remains"},
