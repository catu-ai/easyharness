...
- [ ] A PR for the `0.4.2` patch release is opened against `main`.
- [ ] The PR body states that the release is for the merged repo config query
...
`easyharness_v0.4.2_linux_arm64.zip`, and `SHA256SUMS`.
