...
func SchemaRegistry() []SchemaEntry {
	return []SchemaEntry{
		...
		},
		{
			...
			Description: "One append-only JSONL event line under the configured local runtime root's plan timeline.",
			Shape:       "artifact",
		...
		},
		{
			...
			Description: "Worktree-level pointer artifact under the configured local runtime root.",
			Shape:       "artifact",
		...
		},
		{
			...
			Description: "Plan-local runtime state artifact under the configured local runtime root's plans directory.",
			Shape:       "artifact",
